...
const Profile = () => {
    ...
    const getPublication = async (nextPage = 1, newProfile = false) => {
        ...
        if (data.status == "success") {
            ...
            let newPublications = data.PublicationList;

            if (!newProfile && publications.length >= 1) {
                newPublications = [...publications, ...data.PublicationList]
            }

            if (newProfile) {
                newPublications = data.PublicationList;
                setMore(true)
            }

            setPublications(newPublications)

            if (!newProfile && publications.length >= (data.PublicationList - data.PublicationList.length)) {
                setMore(false)
            }
